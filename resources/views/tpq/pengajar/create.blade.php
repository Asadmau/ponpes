        ...
        <div class="col-sm-8">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">From Ustadz</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                @if(count($errors) > 0)
                ...
                <form method="post" action="{{route('pengajar.store')}}"  enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_pengajar" id="nama_pengajar" placeholder="Nama Ustadz" required>
                      </div>
                    {{-- </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group {{ $errors->has('src_pengajar') ? 'has-error' :'' }}">
                      <label class="control-label">Unggah Foto</label>
                      <input name="src_pengajar" type="file" accept="image/*" >
                      <span class="help-block">{{$errors->first('src_pengajar')}}</span>
                  </div>      
                        <div class="form-group">
